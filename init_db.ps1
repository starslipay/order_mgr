...
$SqlFile = Join-Path $SqlDir "order_init.sql"
...
try {
    ...
    # Secondary confirmation to prevent accidental execution (will drop and recreate order_db)
    ...
    Get-Content -Encoding UTF8 order_init.sql | mysql -h 127.0.0.1 -P 3306 -u root -proot123456
